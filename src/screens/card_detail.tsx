                ...
                <div className='grid grid-flow-row auto-rows-max'>
                    ...
                    <div className='grid grid-cols-1 xl:grid-cols-2'>
                        <div className='inline-flex items-center'>
                            <img src={data.sprites.other.dream_world.front_default} alt={data.name} className='h-36 w-36 rounded-2xl mx-4' />
                            <div>
                                <p className='text-2xl font-normal font-quicksand'>#{data.id}</p>
                                <p className='text-lg font-press-start pt-2 uppercase'>{data.name}</p>
